  ...
  <div class="lcomp-info-table">
    <el-row>
      <el-col v-for="(item, index) in handleConfig" v-bind="item.props" :key="index" class="info-table-tr">
        ...
        <el-form-item class="field-item" v-if="isEdit && item.canEdit && item.field" :prop="item.key" v-bind="item.field.props">
          <component :is="item.field.component" v-bind="item.field.componentProps" v-model="handleValue[item.key]"></component>
        </el-form-item>
